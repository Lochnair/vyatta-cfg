...
Cstore *
Cstore::createCstore(const string& session_id, string& env, bool use_edit_lvl)
{
  return (new unionfs::UnionfsCstore(session_id, env, use_edit_lvl));
}
 ...
 */
bool
Cstore::_deleteCfgPath(const Cpath& path_comps)
{
  string terr;
  ...
  if (!cfg_path_exists(path_comps, false, true, def->isValue())) {
...
Cstore::deleteCfgPath(const Cpath& path_comps)
{
  ...
  return _deleteCfgPath(path_comps);
}
 ...
 */
bool
Cstore::_validateSetPath(const Cpath& path_comps)
{
  // if we can get parsed tmpl, path is valid
  string terr;
...
Cstore::validateSetPath(const Cpath& path_comps)
{
  ...
  return _validateSetPath(path_comps);
}
 ...
 */
bool
Cstore::_validateActivatePath(const Cpath& path_comps)
{
  tr1::shared_ptr<Ctemplate> def(validate_act_deact(path_comps, "activate"));
  if (!def.get()) {
    return false;
  }
  if (!_cfgPathMarkedDeactivated(path_comps)) {
...
Cstore::validateActivatePath(const Cpath& path_comps)
{
  ...
  return _validateActivatePath(path_comps);
}
 ...
 */
bool
Cstore::_validateDeactivatePath(const Cpath& path_comps)
{
...
Cstore::validateDeactivatePath(const Cpath& path_comps)
{
  ...
  return _validateDeactivatePath(path_comps);
}
 ...
 */
bool
Cstore::_getEditEnv(const Cpath& path_comps, string& env)
{
  string terr;
  tr1::shared_ptr<Ctemplate> def(get_parsed_tmpl(path_comps, false, terr));
  if (!def.get()) {
  ...
  if (!cfg_path_exists(path_comps, false, true, def->isValue())) {
     ...
     */
    if (!_validateSetPath(path_comps)) {
...
Cstore::getEditEnv(const Cpath& path_comps, string& env)
{
  ...
  return _getEditEnv(path_comps, env);
}
 ...
 */
bool
Cstore::_getEditUpEnv(string& env)
{
 ...
 */
bool
Cstore::_getEditResetEnv(string& env)
{
  auto_ptr<SavePaths> save(create_save_paths());
 ...
 */
bool
Cstore::_getCompletionEnv(const Cpath& comps, string& env)
{
  string cmd = comps[0];
  ...
  if (pcomps.size() > 0) {
    ...
    if (exists_only &&
        !cfg_path_exists(pcomps, false, true, def->isValue())) {
...
Cstore::getCompletionEnv(const Cpath& comps, string& env)
{
  ...
  return _getCompletionEnv(comps, env);
}
 ...
 */
bool
Cstore::_validateMoveArgs(const Cpath& args)
{
  Cpath epath;
  Cpath nargs;
...
Cstore::validateMoveArgs(const Cpath& args)
{
  ...
  return _validateMoveArgs(args);
}

bool
Cstore::_validateCloneArgs(const Cpath& args)
{
  Cpath epath;
  Cpath nargs;
  if (!conv_move_args_for_rename(args, epath, nargs)) {
    output_user("Invalid clone command\n");
    return false;
  }
  auto_ptr<SavePaths> save(create_save_paths());
  append_cfg_path(epath);
  append_tmpl_path(epath);
  return validate_rename_copy(nargs, "clone");
}

bool
Cstore::validateCloneArgs(const Cpath& args)
{
  ASSERT_IN_SESSION;

  return _validateCloneArgs(args);
}
 ...
 */
bool
Cstore::_renameCfgPath(const Cpath& args)
{
 ...
 */
bool
Cstore::_copyCfgPath(const Cpath& args)
{
  const char *otagnode = args[0];
  const char *otagval = args[1];
  const char *ntagval = args[4];
 ...
 */
bool
Cstore::_commentCfgPath(const Cpath& args)
{
 ...
 */
bool
Cstore::_moveCfgPath(const Cpath& args)
{
  Cpath epath;
  Cpath nargs;
  if (!conv_move_args_for_rename(args, epath, nargs)) {
...
Cstore::moveCfgPath(const Cpath& args)
{
  ...
  return _moveCfgPath(args);
}

bool
Cstore::_cloneCfgPath(const Cpath& args)
{
  Cpath epath;
  Cpath nargs;
  if (!conv_move_args_for_rename(args, epath, nargs)) {
  ...
  append_cfg_path(epath);
  append_tmpl_path(epath);
  return _copyCfgPath(nargs);
}

bool
Cstore::cloneCfgPath(const Cpath& args)
{
  ASSERT_IN_SESSION;

  return _cloneCfgPath(args);
}
...
Cstore::cfgPathExists(const Cpath& path_comps, bool active_cfg)
{
  ...
  return _cfgPathExists(path_comps, active_cfg);
}
                        ...
                        bool include_deactivated)
{
  ...
  return _cfgPathExistsDA(path_comps, active_cfg, include_deactivated);
}
...
Cstore::cfgPathDeleted(const Cpath& path_comps)
{
  ...
  return _cfgPathDeleted(path_comps);
}
...
Cstore::cfgPathAdded(const Cpath& path_comps)
{
  ...
  return _cfgPathAdded(path_comps);
}
 ...
 */
bool
Cstore::_cfgPathChanged(const Cpath& path_comps)
{
  bool active_exists = cfg_path_exists(path_comps, true, false);
  bool working_exists = cfg_path_exists(path_comps, false, false);

  if ((active_exists && !working_exists) ||
      (!active_exists && working_exists)) {
    return true;
  }
  auto_ptr<SavePaths> save(create_save_paths());
  append_cfg_path(path_comps);
...
Cstore::cfgPathChanged(const Cpath& path_comps)
{
  ...
  return _cfgPathChanged(path_comps);
}
                                    ...
                                    vector<string>& cnodes)
{
  ...
  _cfgPathGetDeletedChildNodesDA(path_comps, cnodes, false);
}

// same as above but "deactivate-aware"
void
Cstore::_cfgPathGetDeletedChildNodesDA(const Cpath& path_comps,
                                       vector<string>& cnodes,
                                       bool include_deactivated)
{
  vector<string> acnodes;
  _cfgPathGetChildNodesDA(path_comps, acnodes, true, include_deactivated);
  vector<string> wcnodes;
  _cfgPathGetChildNodesDA(path_comps, wcnodes, false, include_deactivated);
                                      ...
                                      bool include_deactivated)
{
  ...
  _cfgPathGetDeletedChildNodesDA(path_comps, cnodes, include_deactivated);
}
...
Cstore::cfgPathGetDeletedValues(const Cpath& path_comps, vector<string>& dvals)
{
  ...
  _cfgPathGetDeletedValuesDA(path_comps, dvals, false);
}

// same as above but DA
void
Cstore::_cfgPathGetDeletedValuesDA(const Cpath& path_comps,
                                   vector<string>& dvals,
                                   bool include_deactivated)
{
  vector<string> ovals;
  vector<string> nvals;
  if (!_cfgPathGetValuesDA(path_comps, ovals, true, include_deactivated)
      || !_cfgPathGetValuesDA(path_comps, nvals, false, include_deactivated)) {
    return;
  }
                                  ...
                                  bool include_deactivated)
{
  ...
  _cfgPathGetDeletedValuesDA(path_comps, dvals, include_deactivated);
}
 ...
 */
bool
Cstore::_cfgPathDeactivated(const Cpath& path_comps, const bool active_cfg)
{
  Cpath ppath;
  for (size_t i = 0; i < path_comps.size(); i++) {
    ppath.push(path_comps[i]);
    if (_cfgPathMarkedDeactivated(ppath, active_cfg)) {
...
Cstore::cfgPathDeactivated(const Cpath& path_comps, bool active_cfg)
{
  ...
  return _cfgPathDeactivated(path_comps, active_cfg);
}
 ...
 */
bool
Cstore::_cfgPathMarkedDeactivated(const Cpath& path_comps, bool active_cfg)
{
  auto_ptr<SavePaths> save(create_save_paths());
  append_cfg_path(path_comps);
...
Cstore::cfgPathMarkedDeactivated(const Cpath& path_comps, bool active_cfg)
{
  ...
  return _cfgPathMarkedDeactivated(path_comps, active_cfg);
}
                             ...
                             bool active_cfg)
{
  ...
  _cfgPathGetChildNodesDA(path_comps, cnodes, active_cfg, false);
}

// same as above but "deactivate-aware"
void
Cstore::_cfgPathGetChildNodesDA(const Cpath& path_comps,
                                vector<string>& cnodes,
                                bool active_cfg, bool include_deactivated)
{
  if (!include_deactivated && _cfgPathDeactivated(path_comps, active_cfg)) {
                               ...
                               bool active_cfg, bool include_deactivated)
{
  ...
  _cfgPathGetChildNodesDA(path_comps, cnodes, active_cfg, include_deactivated);
}

/* get all items of a node of specified path in working config or active
 * config:
 * get names of child nodes. names are returned in cnodes.
 * get names of existed markers including comment and values.
 * names are returned in markers
 */
void
Cstore::_cfgPathGetChildItems(const Cpath& path_comps,
                              vector<string>& cnodes,
...
{
  {
    auto_ptr<SavePaths> save(create_save_paths());
    append_cfg_path(path_comps);
    get_all_child_item_names(cnodes, cmarkers, active_cfg);
  }
  sort_nodes(cnodes);
}

void
Cstore::_cfgPathChangedItems(const Cpath& path_comps,
...
{
  {
    auto_ptr<SavePaths> save(create_save_paths());
    append_cfg_path(path_comps);
    get_changed_items(mnodes, dnodes, content_changed, content_opaque);
  }
  sort_nodes(mnodes);
  sort_nodes(dnodes);
}
                        ...
                        bool active_cfg)
{
  ...
  return _cfgPathGetValueDA(path_comps, value, active_cfg, false);
}

// same as above but "deactivate-aware"
bool
Cstore::_cfgPathGetValueDA(const Cpath& path_comps, string& value,
                           const bool active_cfg,
                           const bool include_deactivated,
                           const bool path_exists)
{
  ...
  if (!include_deactivated || !path_exists) {
    if (!cfg_path_exists(path_comps, active_cfg, include_deactivated, def->isValue())) {
                          ...
                          bool active_cfg, bool include_deactivated)
{
  ...
  return _cfgPathGetValueDA(path_comps, value, active_cfg, include_deactivated);
}
                         ...
                         bool active_cfg)
{
  ...
  return _cfgPathGetValuesDA(path_comps, values, active_cfg, false);
}

// same as above but "deactivate-aware"
bool
Cstore::_cfgPathGetValuesDA(const Cpath& path_comps, vector<string>& values,
                            const bool active_cfg,
                            const bool include_deactivated,
                            const bool path_exists)
{
                           ...
                           bool active_cfg, bool include_deactivated)
{
  ...
  return _cfgPathGetValuesDA(path_comps, values, active_cfg, include_deactivated);
}
 ...
 */
bool
Cstore::_cfgPathGetComment(const Cpath& path_comps, string& comment,
                           bool active_cfg)
{
  auto_ptr<SavePaths> save(create_save_paths());
  append_cfg_path(path_comps);
                          ...
                          bool active_cfg)
{
  ...
  return _cfgPathGetComment(path_comps, comment, active_cfg);
}
 ...
 */
bool
Cstore::_cfgPathDefault(const Cpath& path_comps, bool active_cfg)
{
  auto_ptr<SavePaths> save(create_save_paths());
  append_cfg_path(path_comps);
...
Cstore::cfgPathDefault(const Cpath& path_comps, bool active_cfg)
{
  ...
  return _cfgPathDefault(path_comps, active_cfg);
}
...
bool
Cstore::_cfgPathEffective(const Cpath& path_comps, const bool in_session)
{
  tr1::shared_ptr<Ctemplate> def(get_parsed_tmpl(path_comps, false));
  if (!def.get()) {
    // invalid path
  ...
  bool in_active = cfg_path_exists(path_comps, true, false, def->isValue());
  if (!in_session) {
    // not in a config session. use active config only.
    return in_active;
  }

  bool in_work = cfg_path_exists(path_comps, false, false, def->isValue());
...
Cstore::cfgPathEffective(const Cpath& path_comps)
{
  ...
  return _cfgPathEffective(path_comps, in_session);
}
                                      ...
                                      vector<string>& cnodes)
{
  if (!inSession()) {
    // not in a config session. use active config only.
    _cfgPathGetChildNodes(path_comps, cnodes, true);
    return;
  }
  ...
  vector<string> acnodes;
  vector<string> wcnodes;
  _cfgPathGetChildNodes(path_comps, acnodes, true);
  _cfgPathGetChildNodes(path_comps, wcnodes, false);
  for (size_t i = 0; i < acnodes.size(); i++) {
    cmap[acnodes[i]] = true;
  }
  for (size_t i = 0; i < wcnodes.size(); i++) {
...
Cstore::cfgPathGetEffectiveValue(const Cpath& path_comps, string& value)
{
  if (!inSession()) {
    // not in a config session. use active config only.
    return _cfgPathGetValue(path_comps, value, true);
  }

  Cpath ppath(path_comps);
  string oval, nval;
  bool oret = _cfgPathGetValue(path_comps, oval, true);
  bool nret = _cfgPathGetValue(path_comps, nval, false);
  bool ret = false;
                                  ...
                                  vector<string>& values)
{
  if (!inSession()) {
    // not in a config session. use active config only.
    _cfgPathGetValues(path_comps, values, true);
  ...
  vector<string> ovals;
  vector<string> nvals;
  _cfgPathGetValues(path_comps, ovals, true);
  _cfgPathGetValues(path_comps, nvals, false);
  for (size_t i = 0; i < ovals.size(); i++) {
    vmap[ovals[i]] = true;
  }
  for (size_t i = 0; i < nvals.size(); i++) {
 ...
 */
bool
Cstore::_markCfgPathDeactivated(const Cpath& path_comps)
{
  if (_cfgPathDeactivated(path_comps)) {
...
Cstore::markCfgPathDeactivated(const Cpath& path_comps)
{
  ...
  return _markCfgPathDeactivated(path_comps);
}
 ...
 */
bool
Cstore::_unmarkCfgPathDeactivated(const Cpath& path_comps)
{
  auto_ptr<SavePaths> save(create_save_paths());
  append_cfg_path(path_comps);
  // note: also mark changed
...
Cstore::unmarkCfgPathDeactivated(const Cpath& path_comps)
{
  ...
  return _unmarkCfgPathDeactivated(path_comps);
}

// load specified config file
bool
Cstore::_loadFile(const char *filename)
{
...
Cstore::loadFile(const char *filename)
{
  if (!inSession()) {
    ...
    assert_internal(false, "calling %s() without config session", __func__);
  }
 ...
 */
bool
Cstore::_unmarkCfgPathChanged(const Cpath& path_comps)
{
  auto_ptr<SavePaths> save(create_save_paths());
  append_cfg_path(path_comps);
...
Cstore::unmarkCfgPathChanged(const Cpath& path_comps)
{
  ...
  return _unmarkCfgPathChanged(path_comps);
}
...
bool
Cstore::markCfgPathCommitted(const CstoreCPathListT& clist)
{
  for (size_t i = 0; i < clist.size(); i++) {
    if (!markCfgPathCommitted(*(clist[i].second.get()), clist[i].first)) {
      return false;
    }
  }
  return true;
...
Cstore::validate_rename_copy(const Cpath& args, const char *op)
{
  ...
  if (!cfg_path_exists(ppath, false, true, def->isValue())) {
 ...
 */
bool
Cstore::cfg_path_exists(const Cpath& path_comps, const bool active_cfg,
                        const bool include_deactivated, const bool is_value)
{
  bool ret = false;
  {
    auto_ptr<SavePaths> save(create_save_paths());
  ...
  if (ret && !include_deactivated
      && _cfgPathDeactivated(path_comps, active_cfg)) {
...
Cstore::set_cfg_path(const Cpath& path_comps, bool output)
{
  ...
  for (size_t i = 0; i < path_comps.size(); i++) {
    ...
    if (!parent_marked) {
      if (!mark_changed_with_ancestors(true)) {
        ret = false;
        break;
      }
      parent_marked = true;
  ...
  if (ret && def->isValue() && def->getDefault()) {
    ...
    bool def_exists;
    if ((ret = unmark_display_default(def_exists)) && def_exists) {
      ...
      // also mark changed
      if (!parent_marked) {
        ret = mark_changed_with_ancestors(true);
      } else {
        ret = mark_changed(true);
      }
    }
  }
  if (path_exists) {
                               ...
                               vector<string> *sorted_keys)
{
  ...
  for (; it != umap.end(); ++it) {
    ...
    if (_cfgPathDeleted(ppath)) {
      cmap[c] = C_NODE_STATUS_DELETED;
    } else if (_cfgPathAdded(ppath)) {
      cmap[c] = C_NODE_STATUS_ADDED;
    } else if (_cfgPathChanged(ppath)) {
                                  ...
                                  vector<string> *sorted_keys)
{
  ...
  _cfgPathGetDeletedChildNodesDA(path_comps, del_nodes);
  ...
  _cfgPathGetChildNodesDA(path_comps, work_nodes, false);
  Cpath ppath(path_comps);
...
Cstore::add_tag(unsigned int tlimit)
{
  ...
  bool ret = false;
  do {
    if (tlimit != 0 && tlimit != UINT32_MAX) {
      vector<string> cnodes;
      // get child nodes, excluding deactivated ones.
      get_all_child_node_names(cnodes, false, false);
      if (tlimit <= cnodes.size()) {
        // limit exceeded
...
void
Cstore::get_all_child_item_names(vector<string>& cnodes,
                                 vector<string>& cmarkers,
                                 const bool active_cfg)
{
  vector<string> nodes, markers;
  get_all_child_item_names_impl(nodes, markers, active_cfg);
  for (size_t i = 0; i < nodes.size(); i ++) {
    cnodes.push_back(nodes[i]);
  }
  for (size_t i = 0; i < markers.size(); i ++) {
    cmarkers.push_back(markers[i]);
  }
}
